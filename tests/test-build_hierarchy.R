...
test_that("match of generated hierarchy", {
  ...
  # due to random order of data and no unique id in fact table the match will be performed table by table using non join operator, as when SQL minus statement
