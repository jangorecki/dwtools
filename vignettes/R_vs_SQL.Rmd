...
# [x] optimize data.equal.data.table
# [ ] add postgres installation to ec2 script
# [x] add volumes support: 5e5, 5e6, 5e7
...
```{r benchmark_timing_save, echo=FALSE}
...
```{r benchmark_timing_summary, echo=FALSE}
# each tool vs mean
...
TO DO summary "R can cover ETL needs well and scalable"
