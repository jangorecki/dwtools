...
DF = as.data.frame(dw.populate(N, S=1, scenario="fact"))
r0 = eval(bquote(timing(DF %>% group_by(cust_code, prod_code, geog_code) %>% summarise_each(funs(sum), amount,value),
...
r0 = eval(bquote(timing(DF %>% group_by(cust_code, geog_code, curr_code) %>% summarise_each(funs(sum), amount,value),
...
r0 = eval(bquote(timing(DF %>% group_by(prod_code, geog_code) %>% summarise_each(funs(sum), amount,value),
